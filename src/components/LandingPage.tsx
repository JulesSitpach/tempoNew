...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Navigation */}
      <nav className="sticky top-0 z-50 border-b border-gray-200 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60 transition-all duration-300">
        <div className="container mx-auto px-6 flex h-16 items-center">
          ...
          <nav className="hidden md:flex items-center space-x-8 ml-12">
            <button
              className="text-gray-600 hover:text-orange-500 font-medium transition-colors duration-200 relative group"
